import ButtonWrapper from "../../../Elements/BackButton";

export default function Contact() {
  return (
    <div className="isolate bg-white px-6 sm:py-6 lg:px-8">
      <ButtonWrapper />
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">
          Tim kami nggak akan bikin kamu nunggu lama,Janji!
        </p>
      </div>
      <form
        action="#"
